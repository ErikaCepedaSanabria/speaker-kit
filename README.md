...
## Quick links 🔗
- **Bio (ES/EN):** `/bio`
- **Talks & abstracts:** `/talks/talks-catalog.md`
- **Photos & banners:** `/media`
- **Branding kit:** `/branding`
- **How to invite me:** `/booking/how-to-invite-me.md`

## What I bring to your event 🎤
- Storytelling + demos + community energy ✨  
- Inclusive, friendly sessions (tech for humans) 🌈  
- Practical takeaways, resources and repos to reuse 📦  

## Contact 📬
- LinkedIn: https://www.linkedin.com/in/erikacepeda/
- Email: erikamcepedasanabria@outlook.com
- Location: Spain (Torrejón de Ardoz) — remote friendly 🌍
